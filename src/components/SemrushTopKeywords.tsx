// src/components/SemrushTopKeywords.tsx (Version 10 - Excel-Design)
'use client';
  ...
  if (isLoading) {
    return (
      <div className="bg-white rounded-lg shadow-md border border-gray-200">
        <div className="p-4 bg-gradient-to-r from-orange-600 to-orange-500 rounded-t-lg">
          <div className="flex items-center gap-2">
            <Search className="text-white" size={20} />
            <h3 className="text-lg font-semibold text-white">Top 20 Organische Keywords - Österreich</h3>
          </div>
        </div>
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 flex flex-col">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="mx-4 mt-4 p-2 bg-blue-50 border border-blue-200 rounded text-xs">
            ...
            <thead className="sticky top-0 z-10">
              <tr className="bg-orange-600 text-white">
                <th 
                  ...
                  className="px-4 py-3 text-left text-sm font-semibold border-r border-orange-500 cursor-pointer hover:bg-orange-700 transition-colors"
                >
                  <div className="flex items-center gap-2">
                    Keyword
                ...
                <th 
                  ...
                  className="px-4 py-3 text-right text-sm font-semibold border-r border-orange-500 cursor-pointer hover:bg-orange-700 transition-colors whitespace-nowrap"
                >
                ...
                <th className="px-4 py-3 text-center text-sm font-semibold border-r border-orange-500 whitespace-nowrap">
                  Änderung
                </th>
                <th 
