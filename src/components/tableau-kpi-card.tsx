...
export default function TableauKpiCard({
  ...
  return (
    <div className={`bg-white rounded-lg border border-gray-200 p-5 transition-all duration-300 hover:shadow-md relative overflow-visible flex flex-col ${className}`}>
