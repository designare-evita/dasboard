          ...
          <div className="space-y-3">
            ...
            <div className="h-6 w-full bg-gray-100/80 rounded-full overflow-hidden flex shadow-inner border border-gray-200/60">
              {counts.Total > 0 ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-xs text-gray-400 bg-gray-50">Keine Landingpages angelegt</div>
              )}
            </div>

            <div className="flex flex-wrap gap-4 mt-2 text-xs text-gray-600">
              <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-green-500"></span><span>Freigegeben ({counts.Freigegeben})</span></div>
              <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-amber-400"></span><span>In Prüfung ({counts['In Prüfung']})</span></div>
              <div className="flex items-center gap-1.5"><span className="w-2.5 h-2.5 rounded-full bg-red-400"></span><span>Gesperrt ({counts.Gesperrt})</span></div>
              <div className="flex items-center gap-1.5 ml-auto font-medium text-gray-800"><BoxSeam size={12} /><span>Gesamt: {counts.Total}</span></div>
            </div>
          </div>
