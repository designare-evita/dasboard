...
interface AiTrafficCardProps {
  ...
  // ✅ NEU: Props für Change und Trend
  totalSessionsChange?: number;
  totalUsersChange?: number;
  trend?: ChartPoint[]; // Array von { date: string, value: number }
...
// ✅ NEU: Hilfskomponente für die Change-Anzeige (wie bei kpi-card)
const ChangeIndicator: React.FC<{ change?: number }> = ({ change }) => {
  // Verstecken, wenn 'change' 0, undefined oder null ist
  if (!change) {
    return null;
  }
...
export default function AiTrafficCard({
  ...
  totalUsers = 0,
  percentage = 0,
  totalSessionsChange, // ✅ NEU
  totalUsersChange,    // ✅ NEU
  trend = [],          // ✅ NEU
  topAiSources = [],
  isLoading = false,
  dateRange = '30d',
  ...
  // ✅ NEU: Sicherstellen, dass Trend-Daten ein Array sind
  ...
  // Ladezustand anzeigen (unverändert)
  if (isLoading) {
    return (
  ...
  // --- ✅ NEUES 2-SPALTEN-LAYOUT (Vorschlag 3) ---
  return (
